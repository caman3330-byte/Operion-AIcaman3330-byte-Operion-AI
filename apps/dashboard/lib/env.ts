...
const serverSchema = z.object({
  ...
  ACQUISITION_COMPANY_WEBSITE_URLS: optionalString,
  ACQUISITION_PUBLIC_DIRECTORY_URLS: optionalString,
  ACQUISITION_CHAMBER_DIRECTORY_URLS: optionalString,
  ACQUISITION_INDUSTRY_ASSOCIATION_URLS: optionalString,
...
export function getConfigurationStatus() {
  return {
    ...
    cloudflare: Boolean(process.env.CLOUDFLARE_ACCOUNT_ID || process.env.CLOUDFLARE_ZONE_ID),
    zoho: Boolean(process.env.ZOHO_CLIENT_ID && process.env.ZOHO_CLIENT_SECRET),
    acquisitionScheduler: process.env.ACQUISITION_SCHEDULER_ENABLED === "true",
    merchantIntelligenceScheduler: process.env.MERCHANT_INTELLIGENCE_SCHEDULER_ENABLED === "true",
